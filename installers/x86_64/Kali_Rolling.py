...
DESCRIPTION = "Installer for Kali Linux running on an emulated x86_64 Processor"


def setup(_):
    """Walk the user through setting up an Kali Linux x86_64 environment
    """
    print()

    url = "http://repo.kali.org/kali/dists/kali-rolling/main/installer-amd64/current/images/netboot/mini.iso"
